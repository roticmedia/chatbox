...
$rotic(document).ready(function () {
  ...
  class chat {
    constructor() {
      ...
      this.iframe = document.getElementById("rotic-iframe").contentWindow;
    }
...
function appendChatbox() {
  return `<div class="rotic-chatbox">
    ...
    <iframe id="rotic-iframe" class="rotic-iframe-chatbox" src="chatbox-frame.html" frameborder="0"></iframe>
</div>
